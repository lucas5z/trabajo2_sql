...
CREATE Table Alumno(
  ...
  FOREIGN KEY (Especialidad) REFERENCES Especialidad(Esp_alumno) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE Table Sesion_clase(
  ...
  Matriculados INT UNSIGNED NOT NULL,
  FOREIGN KEY (Num_clase) REFERENCES Clase(Num_clase) ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE TABLE Alumno_Clase (
  ...
  Pago DECIMAL(4, 2),
  FOREIGN KEY (Cod_alumno) REFERENCES Alumno(Codigo) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (Num_clase) REFERENCES Clase(Num_clase) ON UPDATE CASCADE ON DELETE CASCADE
);
CREATE TABLE Alumno_Sesion_Clase (
  ...
  FOREIGN KEY (Cod_alumno) REFERENCES Alumno(Codigo) ON UPDATE CASCADE ON DELETE CASCADE,
  FOREIGN KEY (Num_clase) REFERENCES Sesion_clase(Num_clase) ON UPDATE CASCADE ON DELETE CASCADE
);